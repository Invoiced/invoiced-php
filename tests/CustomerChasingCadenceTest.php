...
class CustomerChasingCadenceTest extends AbstractEndpointTestCase
{
    ...
    const OBJECT_CLASS = 'Invoiced\\CustomerChasingCadence';
    const EXPECTED_ENDPOINT = '/customer_chasing_cadences/123';
}
