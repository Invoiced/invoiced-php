...
class InvoiceChasingCadenceTest extends AbstractEndpointTestCase
{
    ...
    const OBJECT_CLASS = 'Invoiced\\InvoiceChasingCadence';
    const EXPECTED_ENDPOINT = '/invoice_chasing_cadences/123';
}
