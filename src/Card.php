...
class Card extends PaymentSource
{
    ...
    {
        throw new BadMethodCallException('Card does not support create(). Please use PaymentSource class.');
    }
    ...
    {
        throw new BadMethodCallException('Card does not support all(). Please use PaymentSource class.');
    }
